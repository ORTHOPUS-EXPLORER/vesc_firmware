...
#define SINCOS_MIN_AMPLITUDE        0.9         // sqrt(sin^2 + cos^2) has to be larger than this
#define SINCOS_MAX_AMPLITUDE        1.1         // sqrt(sin^2 + cos^2) has to be smaller than this
